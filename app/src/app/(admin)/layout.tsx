...
export default function AdminLayout({
  ...
  const navItems = [
    ...
    { href: "/dashboard/components", label: "Components", icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" },
    { href: "/dashboard/maintenance", label: "Maintenance", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
    { href: "/dashboard/subscribers", label: "Subscribers", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" },
    ...
    { href: "/dashboard/embed", label: "Embed", icon: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" },
    { href: "/dashboard/api-docs", label: "API Docs", icon: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" },
