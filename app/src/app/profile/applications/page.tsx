...
export default function ApplicationsPage() {
  const [activeTab, setActiveTab] = useState<"my-apps" | "browse" | "add">(
    "my-apps"
  );
    ...
    <main className="min-h-screen bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Manage your applications, monitor their status, and discover new
            services to track.
          </p>
        </div>
            ...
            <section>
              <div className="mb-6">
                ...
                <p className="text-gray-400 text-sm">
                  Monitor the status and uptime of applications you&apos;re
                  subscribed to.
                </p>
              </div>
          ...
          {activeTab === "browse" && (
            <section>
              <div className="mb-6">
                ...
                <p className="text-gray-400 text-sm">
                  Discover and subscribe to applications to monitor their
                  status.
                </p>
              </div>
              <ApplicationsSearch
                key={`browse-${refreshKey}`}
                onSubscribedChange={handleRefresh}
              />
            </section>
          )}
          ...
          {activeTab === "add" && (
            <section>
              <div className="mb-6">
                ...
                <p className="text-gray-400 text-sm">
                  Add a new application to the platform for monitoring and
                  sharing.
                </p>
              </div>
