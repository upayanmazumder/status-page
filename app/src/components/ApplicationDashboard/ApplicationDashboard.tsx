...
const ApplicationDashboard = () => {
  ...
  const fetchDashboards = async () => {
    try {
      ...
      // Update selectedDashboard if it was open
  ...
  // Fetch all applications (for adding to dashboards)
  ...
  // Remove application from dashboard
  ...
  return (
    <div className="max-w-3xl mx-auto p-4 text-gray-100 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 min-h-screen transition-colors duration-500">
